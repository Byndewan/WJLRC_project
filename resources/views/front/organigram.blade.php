                        ...
                        <div class="team-member">
                            <div class="member-img">
                                ...
                                <div class="social">
                                    ...
                                    <a href="{{ $data_organigram_pembina->icon_url4 }}"><i class="{{ $data_organigram_pembina->icon4 }}"></i></a>
                                    <a href="{{ $data_organigram_pembina->icon_url5 }}"><i class="{{ $data_organigram_pembina->icon5 }}"></i></a>
                                </div>
                            </div>

...
<head>
  ...
  <title>Liputan dan Dokumentasi</title>
  ...
  <!-- Main CSS File -->
  <link href="{{ asset('dist_front/liputan/css/main.css') }}" rel="stylesheet">
  <link href="{{ asset('dist_front/liputan/css-2/main.css') }}" rel="stylesheet">
        ...
        <div class="row g-5">
          <div class="col-lg-4">
            <div class="post-entry-1 lg">
              <a href=""><img src="{{ asset('dist_front/liputan/img/maulid_nabi.jpeg') }}" alt="" class="img-fluid"></a>

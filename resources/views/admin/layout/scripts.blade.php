...
<script src="{{ asset('dist/modules/simple-weather/jquery.simpleWeather.min.js') }}"></script>
<script src="{{ asset('dist/modules/chart.min.js') }}"></script>
<script src="{{ asset('dist/modules/jqvmap/dist/jquery.vmap.min.js') }}"></script>
<script src="{{ asset('dist/modules/jqvmap/dist/maps/jquery.vmap.world.js') }}"></script>

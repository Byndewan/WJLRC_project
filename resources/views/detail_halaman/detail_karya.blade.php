              ...
              <div class="col-lg-12">
                ...
                <div class="row">
                  <div class="col-12 mb-3">
                    <textarea class="form-control" id="comment-message" placeholder="Enter your name" cols="30" rows="10" style="margin-top: 5px;"></textarea>
                  </div>
                  <div class="col-12">
...
People</a></h2>
<span class="author mb-3 d-block">Stephen Covey</span>
</div>

<div class="post-entry-1 border-bottom">
<h2 class="mb-2"><a href="#">The Alchemist</a></h2>
<span class="author mb-3 d-block">Paulo Coelho</span>
</div>

<div class="post-entry-1 border-bottom">
<h2 class="mb-2"><a href="#">Man’s Search for Meaning</a></h2>
<span class="author mb-3 d-block">
Viktor E. Frankl</span>
</div>

<div class="post-entry-1 border-bottom">
<h2 class="mb-2"><a href="#">Cara Gila Mengubah Diri</a></h2>
<span class="author mb-3 d-block">
Syaifulloh</span>
</div>

<div class="post-entry-1 border-bottom">
<h2 class="mb-2"><a href="#">Pertanyaan Umum tentang Buku yang
Mengubah Hidup</a></h2>

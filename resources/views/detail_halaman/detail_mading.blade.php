...
@section('main_content')
            ...
            <div class="single-post" style="margin-bottom: 50px;">
              <div class="post-meta"><span>{{ $data_mading->tanggal }}</span></div>
              <h1 class="mb-5">{{ $data_mading->judul }}</h1>
            ...
            @foreach ($mading_data as $item)
                <div class="tab-pane fade show active" id="pills-popular" role="tabpanel" aria-labelledby="pills-popular-tab">
                  <div class="post-entry-1 border-bottom">
                    ...
                    <h2 class="mb-2"><a href="{{ route('detail_mading', $item->id) }}">{{ $item->judul }}</a></h2>

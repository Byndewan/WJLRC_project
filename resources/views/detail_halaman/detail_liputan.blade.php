...
@section('main_content')
            <div class="single-post">
              <div class="post-meta"><span class="date">Maulid Nabi</span> <span class="mx-1">&bullet;</span> <span> Senin, 16 September 2024.</span></div>
              <h1 class="mb-5">Ini adalah salahsatu Dokumentasi Dari kami </h1>
              ...
              <figure class="my-4">
                <img src="assets/img/maulid nabi.png" alt="" class="img-fluid">

...
@section('main_content')
            <div class="single-post">
              <div class="post-meta"><span class="date">Liputan</span> <span class="mx-1">&bullet;</span> <span>16 September 2024.</span></div>
              <h1 class="mb-4">ini adalah Salah satu Dokumentasi dari kami</h1>

...
@section('main_content')
            ...
            <div class="single-post" style="margin-bottom: 50px;">
              ...
              <h1 class="mb-5">Maulid Nabi 2023</h1>
              <p class="post-meta" style="margin-bottom : 20px; font-size: 15px;">Pasya Fadla Fauzan</p>
              <figure class="my-4">
                <img src="{{ asset('dist_detail/assets/img/maulid nabi.png') }}" alt="" class="img-fluid" style="max-width: 900px">
                <figcaption>Acara Maulid Nabi SMK Budi Bakti Ciwidey </figcaption>
              </figure>

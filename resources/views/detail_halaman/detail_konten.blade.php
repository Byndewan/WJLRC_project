...
@section('main_content')
    <!-- ======= Single Post Content ======= -->
            <div class="single-post" style="margin-bottom: 50px;">
              ...
              <h1 class="mb-5">Bagaimana sih cara menghitung perkalian 9 dengan mudah?</h1>
              <p class="post-meta" style="margin-bottom : 20px; font-size: 15px;">Gista Aulia</p>
              <figure class="my-4">
                <img src="{{ asset('dist_detail/assets/img/konten-4.jpg') }}" alt="" class="img-fluid" style="max-width: 900px">
                <figcaption>Perkalian 9</figcaption>
              </figure>

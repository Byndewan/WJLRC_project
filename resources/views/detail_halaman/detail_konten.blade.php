...
@section('main_content')
    <div class="single-post">
        <div class="post-meta"><span class="date">Konten</span> <span class="mx-1">&bullet;</span> <span>16 September 2024.</span></div>
        ...
        <p><span class="firstcharacter">L</span>orem ipsum dolor sit, amet consectetur adipisicing elit. Ratione officia sed, suscipit distinctio, numquam omnis quo fuga ipsam quis inventore voluptatum recusandae culpa, unde doloribus saepe labore alias voluptate expedita? Dicta delectus beatae explicabo odio voluptatibus quas, saepe qui aperiam autem obcaecati, illo et! Incidunt voluptas culpa neque repellat sint, accusamus beatae, cumque autem tempore quisquam quam eligendi harum debitis.</p>
            ...
            <figure class="my-4">
            <img src="assets/img/azlia.jpg" alt="" class="img-fluid">
            ...
            <h2 class="mb-2"><a href="#">Bagaimana sih cara menghitung perkalian 9 dengan mudah?</a></h2>
            <span class="author mb-3 d-block">Gista aulia</span>
            </div>
            ...
            <div class="post-entry-1 border-bottom">
            <h2 class="mb-2"><a href="#">Apasih Literasi itu?</a></h2>
            <span class="author mb-3 d-block">Nameera putri prianti</span>
            </div>

            <div class="post-entry-1 border-bottom">
            <h2 class="mb-2"><a href="#">Cara mengatur keuangan di usia muda</a></h2>
            <span class="author mb-3 d-block">Andiki</span>
            </div>

            <div class="post-entry-1 border-bottom">
            <h2 class="mb-2"><a href="#">Teknologi internet</a></h2>
            <span class="author mb-3 d-block">Cantika</span>
            </div>

            <div class="post-entry-1 border-bottom">
            <h2 class="mb-2"><a href="#">Tips membangun kerjasama tim yang baik</a></h2>
            <span class="author mb-3 d-block">Desma</span>
            </div>
            </div> <!-- End Popular -->
            ...
            <div class="post-entry-1 border-bottom">
            <h2 class="mb-2"><a href="#">Manajemen Keuangan Pribadi</a></h2>
            <span class="author mb-3 d-block">Jenny Wilson</span>
            </div>
            <div class="post-entry-1 border-bottom">
            <h2 class="mb-2"><a href="#">Bagai mana sih cara Perkalian 9 dengan mudah?  </a></h2>
            <span class="author mb-3 d-block">Jenny Wilson</span>
            </div>

            <div class="post-entry-1 border-bottom">
            <h2 class="mb-2"><a href="#">5 cara Efektif Mengatur Waktu  Dengan Baik</a></h2>
            <span class="author mb-3 d-block">Jenny Wilson</span>
            </div>
            </div> <!-- End Trending -->

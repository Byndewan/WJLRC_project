...
@section('main_content')
            ...
            <div class="single-post">
              <div class="post-meta"><span class="date">resensi</span> <span class="mx-1">&bullet;</span> <span> Senin, 16 September 2024.</span></div>
              <h1 class="mb-4">Dago  Setelah Hujan Karya Skyshpir</h1>
              <div class="mb-5"><span class="date">Azlia</span> <span class="mx-1">&bullet;</span> <span>Ahmad Pasya</span></div>
              ...
              <figure class="my-4">
                <img src="assets/img/resensi.png" alt="" class="img-fluid">
              ...
              <figure class="my-4">
                <img src="assets/img/resensi.jpg" alt="" class="img-fluid">
                <figcaption>Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo, odit? </figcaption>
              </figure>
            ...
            <div class="comments">
              ...
              <div class="comment d-flex">
                <div class="flex-shrink-0">
                  <div class="avatar avatar-sm rounded-circle">
                    <img class="avatar-img" src="assets/img/person-2.jpg" class="img-fluid">
                  </div>
                </div>
          ...
          <div class="col-md-3">
            ...
            <div class="aside-block">
              <div class="tab-content" id="pills-tabContent">
                ...
                <!-- Popular -->
                <div class="tab-pane fade show active" id="pills-popular" role="tabpanel" aria-labelles?dby="pills-popular-tab">
                  <div class="post-entry-1 border-bottom">
                    <h2 class="mb-2"><a href="#">Anchika Karya Pidi Baiq</a></h2>
                    <span class="author mb-3 d-block">Ahmad Pasya</span>
                  </div>

                  <div class="post-entry-1 border-bottom">
                    <h2 class="mb-2"><a href="#">Filosofi Teras Karya Henry Manam</a></h2>
                    <span class="author mb-3 d-block">Azlia</span>
                  </div>

                  <div class="post-entry-1 border-bottom">
                    <h2 class="mb-2"><a href="#">Madilog Karya Tan Malaka</a></h2>
                    <span class="author mb-3 d-block">Mujib M.Yasin</span>
                  </div>

                  <div class="post-entry-1 border-bottom">
                    <h2 class="mb-2"><a href="#">Kamu Gak Sendiri Karya Syahid</a></h2>
                    <span class="author mb-3 d-block">Mawar Riani</span>
                  </div>

                  <div class="post-entry-1 border-bottom">
                    <h2 class="mb-2"><a href="#">The Power Of Habit Karya Charles</a></h2>
                    <span class="author mb-3 d-block">Mujib M.Yasin</span>
                  </div>

                  <div class="post-entry-1 border-bottom">
                    <h2 class="mb-2"><a href="#">Sekolah Itu Candu Karya Roem Topati</a></h2>
                    <span class="author mb-3 d-block">Mawar</span>
                  </div>
                </div> <!-- End Popular -->
